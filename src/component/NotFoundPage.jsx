import { faSadCry,faComment } from "@fortawesome/free-solid-svg-icons";
...
export function NotFoundPage() { // <--- Named export
  return (
    ...
    <div className="flex flex-column align-items-center justify-content-center">
        <FontAwesomeIcon icon={faSadCry} style={{color: "#74C0FC",}} className="mb-5 w-6rem flex-shrink-0" size="6x"/>
        <div
            style={{
                borderRadius: '56px',
                padding: '0.3rem',
            ...
            <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                ...
                <div className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                    ...
                    <span className="ml-4 flex flex-column">
                        ...
                        <span className="text-600 lg:text-lg">FAQ.</span>
                    </span>
                </div>
                <div className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                    ...
                    <span className="ml-4 flex flex-column">
                        ...
                        <span className="text-600 lg:text-lg">Contact support team!</span>
                    </span>
                </div>
                <div className="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                    ...
                    <span className="ml-4 flex flex-column">
                        ...
                        <span className="text-600 lg:text-lg">Contact Admin!</span>
                    </span>
                </div>
            </div>
        </div>
...
/* export default function NotFoundPage(){
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
            <div className="flex flex-column align-items-center justify-content-center">
                <FontAwesomeIcon icon={faComment} style={{color: "#63E6BE",}} className="mb-5 w-6rem flex-shrink-0"/>
                <div
                    style={{
                        borderRadius: '56px',
                        padding: '0.3rem',
